...
const Login = () => {
  ...
  const handleSendOtp = async () => {
    ...
    try {
      ...
      // FOR TESTING: Always use simulation mode to avoid sending real emails
      console.log("TEST MODE: OTP is", newOtp);
      toast({
        title: "Verification Code (Test Mode)",
        description: `Your OTP is: ${newOtp}. Please enter this to login.`,
        duration: 10000,
      });
      setOtpSent(true);

      /* 
      // Original EmailJS logic (Commited for later use)
      ...
      if (!serviceId || !templateId || !publicKey) {
        ...
        await emailjs.send(
          ...
          { to_email: email, to_name: email.split('@')[0], otp_code: newOtp, subject: `Verification Code: ${newOtp}`, message: `Your verification code is ${newOtp}` },
          publicKey
        );
        setOtpSent(true);
  ...
  const roles: { value: UserRole; label: string; desc: string }[] = [
    ...
    { value: "delivery_boy", label: "Delivery Boy", desc: "Manage assigned deliveries" },
            ...
            <CardContent className="space-y-5">
              ...
              <div className="pt-4 border-t border-border text-center">
                ...
                <p className="text-sm text-muted-foreground mt-2">
                  ...
                  <a href="/register/shopkeeper" className="text-primary font-medium hover:underline">Register Shop</a>
                </p>
              </div>
            </CardContent>
          </Card>
